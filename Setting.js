...
global.owner = process.env.OWNER_NUMBER  || '254758051772' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://Lennox:Xonnil20@@cluster27.jvds4ug.mongodb.net/?retryWrites=true&w=majority&appName=Cluster27" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.mztit = process.env.MZTIT ||"Lennox",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '08_07_2024_SIGMA_MD_hp5zwpmZ_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'Lennox-Machine',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `Lennox-Gutierrez`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'Gutierrez',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "Lennox-Sticker" ,          // ADD YOUR STICKER PACKNAME
